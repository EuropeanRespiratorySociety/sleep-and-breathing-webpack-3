<template>
  <v-flex xs12 sm12 md8 lg8 offset-md2 offset-lg2>
    ...
    <v-layout row wrap>
      <v-flex xs12 sm6>
        <v-card href="http://www.ers-education.org/publications/handbook-series/ers-handbook-of-respiratory-sleep-medicine.aspx">
          <v-container fluid grid-list-lg>
            <v-layout row>
              <v-flex xs8>
                <div>
                  <div class="headline">Sleep Medicine Textbook</div>
                  <p class="grey--text lighten-5">Endorsed by ERS</p>
                  <p>Based on the <a target="_blank" href="http://onlinelibrary.wiley.com/doi/10.1111/jsr.12095/abstract">
            ...
            <v-layout row>
              <v-flex xs8>
                <div>
                  ...
                  <p class="grey--text lighten-5">Endorsed by ESRS</p>
                  <p>Accredited by European Board for Accreditation in Pneumology (EBAP)</p>
                </div>
              </v-flex>
              <v-flex xs4>
                <v-card-media
